  ...
  if (choice == 1) {
      ...
      const cfg = {
          args: [
              ...
              `--disable-extensions-except=${path.resolve("eklentiler", "captcha-system", "1.3.1_0")}`,
              `--load-extension=${path.resolve("eklentiler", "captcha-system", "1.3.1_0")}`,
          ],
      ...
      puppeteer.use(
          RecaptchaPlugin({
              provider: {
                  id: "2captcha",
                  //token: "3cb6c31ee5e74ec02b983ce354c4e9a0"
              },
              visualFeedback: true,
              throwOnError: true,
          })
      ...
      async function create_accinfos(chrome, disc) {
          ...
          const password = "Muhammed20075345"; //T�M OLUSTURDUGUN TOKENLER�N ��FRELER� BU OLACAK
